...
class UnspentReservoir extends Reservoir<_UnspentKey, Unspent> {
  ...
  UnspentReservoir() : super(_UnspentKey()) {
  ...
  Set<String> get getSymbols => res.unspents.data.map((e) => e.symbol).toSet();
