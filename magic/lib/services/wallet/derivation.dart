...
//   bool gapSatisfied(LeaderWallet leader, [Exposure? exposure]) =>
//       exposure != null
//           ? leader.gapAddresses(exposure).length >= requiredGap
//           : gapSatisfied(leader, Exposure.external) &&
//               gapSatisfied(leader, Exposure.internal);
...
//   ]) async {
//     exposures = exposures ??
//         <Exposure>[Exposure.external, Exposure.internal];
//     final Set<Address> newAddresses = <Address>{};
//     for (final Exposure exposure in exposures) {
...
//   static String produceKey(String walletId, Exposure exposure) =>
