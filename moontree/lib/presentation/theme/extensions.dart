...
extension ValueColorExtension on ThemeData {
  ...
  Color? get bad =>
      brightness == Brightness.light ? AppColors.error : AppColors.error;
}
...
extension TextThemeStyleExtension on TextTheme {
  ...
  /// extras
  TextStyle get wholeHolding => AppText.wholeHolding;
  TextStyle get partHolding => AppText.partHolding;
  TextStyle get usdHolding => AppText.usdHolding;
  TextStyle get labelHolding => AppText.labelHolding;
