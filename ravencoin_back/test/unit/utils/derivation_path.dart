...
void main() {
  test('derive', () {
    ...
    expect(getDerivationPath(0, exposure: NodeExposure.external, net: Net.main),
        "m/44'/175'/0'/0/0");
    expect(getDerivationPath(0, exposure: NodeExposure.internal, net: Net.main),
        "m/44'/175'/0'/1/0");
    expect(getDerivationPath(1, exposure: NodeExposure.internal, net: Net.main),
        "m/44'/175'/0'/1/1");
  });
}
