...
import 'package:client_front/pages/home/home.dart';
import 'package:client_front/pages/manage/assets.dart';
import 'package:client_front/pages/manage/create/nft.dart';
import 'package:client_front/pages/manage/create/main.dart';
import 'package:client_front/pages/manage/create/sub.dart';
import 'package:client_front/pages/manage/create/qualifier.dart';
import 'package:client_front/pages/manage/create/qualifiersub.dart';
import 'package:client_front/pages/manage/create/channel.dart';
import 'package:client_front/pages/manage/create/restricted.dart';
import 'package:client_front/pages/manage/reissue/restricted.dart';
import 'package:client_front/pages/manage/reissue/main.dart';
import 'package:client_front/pages/manage/reissue/sub.dart';
import 'package:client_front/pages/misc/splash.dart';
import 'package:client_front/pages/misc/scan.dart';
import 'package:client_front/pages/misc/checkout.dart';
import 'package:client_front/pages/security/backup/keypair.dart';
import 'package:client_front/pages/security/backup/intro.dart';
import 'package:client_front/pages/security/backup/show.dart';
import 'package:client_front/pages/security/backup/verify.dart';
import 'package:client_front/pages/security/create_choice.dart';
import 'package:client_front/pages/security/create_native.dart';
import 'package:client_front/pages/security/create_password.dart';
import 'package:client_front/pages/security/login_password.dart';
import 'package:client_front/pages/security/login_native.dart';
import 'package:client_front/pages/security/resume.dart';
import 'package:client_front/pages/security/change_password.dart';
import 'package:client_front/pages/security/change_method.dart';
import 'package:client_front/pages/settings/about.dart';
import 'package:client_front/pages/settings/advanced.dart';
import 'package:client_front/pages/settings/export.dart';
import 'package:client_front/pages/settings/feedback.dart';
import 'package:client_front/pages/settings/import.dart';
import 'package:client_front/pages/settings/language.dart';
import 'package:client_front/pages/settings/network.dart';
import 'package:client_front/pages/settings/mining.dart';
import 'package:client_front/pages/settings/database.dart';
import 'package:client_front/pages/settings/developer.dart';
import 'package:client_front/pages/settings/userlevel.dart';
import 'package:client_front/pages/settings/preferences.dart';
import 'package:client_front/pages/settings/support.dart';
import 'package:client_front/pages/settings/sweep.dart';
import 'package:client_front/pages/settings/technical.dart';
import 'package:client_front/pages/settings/addresses.dart';
//import 'package:client_front/pages/settings/currency.dart';
//import 'package:client_front/pages/settings/wallet.dart';
import 'package:client_front/pages/wallet/receive.dart';
import 'package:client_front/pages/wallet/send.dart';
import 'package:client_front/pages/wallet/transaction.dart';
//import 'package:client_front/pages/wallet/transactions.dart';
import 'package:client_front/pages/wallet/transactions/widget.dart';
import 'package:client_front/widgets/front/verify.dart';
