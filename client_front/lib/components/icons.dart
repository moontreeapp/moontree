...
import 'package:client_front/utils/alphacon.dart';
import 'package:client_front/widgets/assets/assets.dart' as assets;
...
*/
/*
  import 'package:client_front/services/identicon.dart';
  /// no logo? no problem, we'll make one...
  /// Remove the `!` when calculating hash, so each master asset
  /// matches its corresponding regular asset autogenerated colors.
