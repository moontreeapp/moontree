...
final _staticRoutes = <String, Widget Function(BuildContext)>{
  ...
  //v3
  '/login/create': (BuildContext context) => FrontCreateScreen(),
  '/login/create/native': (BuildContext context) => FrontCreateNativeScreen(),
  '/login/create/password': (BuildContext context) =>
      FrontCreatePasswordScreen(),
  '/login/native': (BuildContext context) => FrontNativeScreen(),
  '/login/password': (BuildContext context) => const FrontPasswordScreen(),
};
