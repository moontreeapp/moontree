...
class SimpleReissue extends StatefulWidget {
  final dynamic data;
  const SimpleReissue({Key? key, this.data}) : super(key: key);
...
class _SimpleReissueState extends State<SimpleReissue> {
  ...
  void initState() {
    super.initState();
    BlocProvider.of<SimpleReissueFormCubit>(context).reset();
  ...
  void populateFromData(SimpleReissueFormCubit cubit) {
    if (data.isNotEmpty) {
  ...
  Widget build(BuildContext context) {
    final SimpleReissueFormCubit cubit =
        BlocProvider.of<SimpleReissueFormCubit>(context);
  ...
  bool _holdingValidation(SimpleReissueFormState state) {
  ...
  void _confirmSend(
      SendRequest sendRequest, SimpleReissueFormCubit cubit) async {
