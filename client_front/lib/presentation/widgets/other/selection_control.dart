...
class CustomMaterialTextSelectionControls
  ...
  Widget buildHandle(
      ...
      [VoidCallback? onTap]) {
    final ThemeData theme = Theme.of(this.context ?? context);
    final Color handleColor =
        TextSelectionTheme.of(this.context ?? context).selectionHandleColor ??
...
class _TextSelectionControlsToolbarState
  ...
  Widget build(BuildContext context) {
    ...
    // appearance.
    assert(debugCheckHasMaterialLocalizations(widget.context ?? context));
    final MaterialLocalizations localizations =
        MaterialLocalizations.of(widget.context ?? context);
