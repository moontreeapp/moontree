...
import 'package:client_front/infrastructure/cache/mempool_transactions.dart';
import 'package:client_front/infrastructure/calls/mempool_transactions.dart';
import 'package:client_front/infrastructure/repos/repository.dart';
import 'package:client_front/infrastructure/services/lookup.dart';

class MempoolTransactionHistoryRepo
    extends Repository<Iterable<TransactionView>> {
  late Wallet wallet;
  late String? symbol;
  ...
  @override
  Iterable<TransactionView>? fromLocal() => MempoolTransactionsCache.get(
        wallet: wallet,
        chain: chain,
        net: net,
  ...
  @override
  Future<void> save() async => MempoolTransactionsCache.put(
        wallet: wallet,
        chain: chain,
        net: net,
        records: results,
