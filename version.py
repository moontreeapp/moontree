...
def user():
    ...
    parser.add_argument('-b', "--build", default=False, help="increments the build number")
    parser.add_argument('-p', "--patch", default=False, help="increments the patch number")
    parser.add_argument('-n', "--minor", default=False, help="increments the minor number")
    parser.add_argument('-j', "--major", default=False, help="increments the major number")
    args = parser.parse_args()
    if args.patch or args.minor or args.major:
        args.build = True
    # do the thing...

class ravencoin_back():   
    ...
    def _replaceValues(self, versionName, buildName, platformName, lines, version='beta'):
        ...
        self.existingVersions.append(self.existingVersion + '+' + self.existingBuild)
